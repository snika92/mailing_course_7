...
from .views import CustomLoginView, RegisterView, email_verification, UserListView, BlockUserView, UserDetailView, \
    UserUpdateViews, UserForgotPasswordView, UserPasswordResetConfirmView
